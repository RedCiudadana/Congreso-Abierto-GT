...
ActiveRecord::Schema.define(:version => 20140419233209) do
...
#   Unknown type 'tsvector' for column 'fti_names'
...
# Could not dump table "bill_fulltext" because of following StandardError
#   Unknown type 'tsvector' for column 'fti_names'
...
# Could not dump table "bill_titles" because of following StandardError
#   Unknown type 'tsvector' for column 'fti_titles'
...
# Could not dump table "commentaries" because of following StandardError
#   Unknown type 'tsvector' for column 'fti_names'
...
# Could not dump table "committees" because of following StandardError
#   Unknown type 'tsvector' for column 'fti_names'
  ...
  create_table "diputados", :force => true do |t|
    ...
    t.string "correo"
    t.string "telefono"
    t.string "partido_postulante"
    t.string "partido_actual"
    t.string "direccion"
    t.string "ext"
...
# Could not dump table "upcoming_bills" because of following StandardError
#   Unknown type 'tsvector' for column 'fti_names'

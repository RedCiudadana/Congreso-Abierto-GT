...
describe "asig_bill_diputados/edit" do
  before(:each) do
  ...
  it "renders the edit asig_bill_diputado form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => asig_bill_diputados_path(@asig_bill_diputado), :method => "post" do
